...
export default function Quotes() {
  const quotes = useSelector(st => st.quoteState.quotes)
  const displayAllQuotes = useSelector(st => st.quoteState.displayAllQuotes)
  const highlightedQuote = useSelector(st => st.quoteState.highlightedQuote)
